...
export default class UIManager {
  ...
  private async _genUIBaseAsync(
    ...
    let prefab = await AsyncHelper.loadAsync<Prefab>(
      bundle,
      prefixPath + conf.name,
      Prefab
    );
