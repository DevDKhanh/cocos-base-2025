...
export default class DebugManger {
  ...
  private _initLogPanel() {
    ...
    CocosHelper.addSprite(logPanel, {
      spriteFrame: CocosHelper.genPureColorSpriteFrame(color(0, 0, 0, 180)),
    });
  ...
  private _addLblNode(msg: string, clr?: Color) {
    ...
    nd.getComponent(UITransform).width =
      this.logContent.parent.getComponent(UITransform).width - 20;
